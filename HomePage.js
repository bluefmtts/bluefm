                            ...
                            <section className="mb-12">
                                ...
                                <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                                    {featuredNovels.slice(0, 3).map(novel => (
                                        ...
                                        >
                                            <img 
                                                src={novel.coverImage || novel.coverUrl || `https://picsum.photos/400/300?random=${novel.id}`}
                                                alt={novel.title}
                                    ...
                                    {latestChapters.map(({ novel, chapter }) => (
                                        ...
                                        >
                                            <div className="flex gap-4">
                                                <img 
                                                    src={novel.coverImage || novel.coverUrl || `https://picsum.photos/100/150?random=${novel.id}`}
                                                    alt={novel.title}
